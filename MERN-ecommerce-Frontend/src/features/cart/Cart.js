    ...
    <>
      ...
      <div>
        ...
        >
          ...
          <div className="px-4 py-6 sm:px-6 bg-yellow-50 rounded-lg mt-10">
          ...
          <div className="px-4 py-6 sm:px-6">
            <div className="mt-10 flex justify-center">
              <Link
                to="/checkout"
                className="flex items-center justify-center rounded-md border border-transparent bg-indigo-500 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                style={{ minWidth: "30%" }}
              >
                Checkout
              </Link>
            ...
            <div className="mt-6 flex justify-center text-center text-sm text-gray-400">
              <p>
                ...
                <Link to="/home">
                  <button
                    type="button"
                    className="font-medium text-indigo-500 hover:text-indigo-700 pl-1"
                  >
                    Continue Shopping
